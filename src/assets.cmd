for %%f in (images\*.png images\fonts\*.png) do "..\..\..\Delphi\bmp2tile\bmp2tile.exe" "%%f" -tileoffset 0 -savetiles "%%f.tiles.zx7" -savetilemap "%%f.tilemap.zx7" -fullpalette -savepalette "%%f.palette.bin" -exit
